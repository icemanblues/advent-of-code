...
function getOrDefault(m: Map<number, number>, k: number, d: number) {
...
function part1() {
    ...
    const amp: Amp = new Amp('part1', lines, [1], []);
    console.log('part1', prog(amp));
}

function part2() {
    console.log('Part 2');
    const lines: number[] = readInputSync('input.txt').map(Number);
    const amp: Amp = new Amp('part1', lines, [2], []);
    console.log('part1', prog(amp));
}
